...
public class BankSystemAd extends JFrame implements ActionListener, ItemListener {
    ...
    public BankSystemAd() {
        ...
        setIconImage(getToolkit().getImage("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/Bank.gif"));
        setSize(700, 550);
        setJMenuBar(bar);
        ...
        end = new JMenuItem("Quit BankSystem ?", new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/export.gif"));
        ...
        delRec = new JMenuItem("Delete Customer", new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/Delete.gif"));
        ...
        search = new JMenuItem("Search By No.", new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/find.gif"));
        ...
        allCustomer = new JMenuItem("View All Customer", new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/refresh.gif"));
        ...
        content = new JMenuItem("Help Contents", new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images\\paste.gif"));
        ...
        about = new JMenuItem("About BankSystem", new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images\\Save.gif"));
        ...
        btnWith = new JButton(new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/SuperDisk.gif"));
        ...
        btnHelp = new JButton(new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/Help.gif"));
        btnHelp.setToolTipText("Help on Bank System");
        btnHelp.addActionListener(this);
        btnKey = new JButton(new ImageIcon("C:\\Users\\bekal\\Downloads\\Compressed\\BankManagementSystem\\src\\Images/Keys.gif"));
        ...
        author = new JLabel(" " + "Mankira Bank [Pvt] Limited.", Label.LEFT);
...
//		setVisible (true);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (obj == addNew || obj == open || obj == btnNew) {
            ...
            boolean b = openChildWindow("system Help");
            if (b == false) {
            ...
            boolean b = openChildWindow("system Keys");
            if (b == false) {
            ...
            String msg = "Mankira Bank [Pvt] Limited.\n\n" + "Created & Designed By:\n"
                    + "Mankira Bank\n\n" + "E-mail me:\n manikiraBank.customer_center@gmail.com";
    ...
    private void quitApp() {
        ...
        try {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                System.out.println("Thanks for Choosing Mankira Bank - Mankira Bank");
                System.exit(0);
    ...
    String makeRecordPrint(int rec) {
        ...
        String data6 = "          Copyright � 2023 Mankira Bank.\n";	//Page Footer.
        String sep0 = " -----------------------------------------------------------\n";
        String sep1 = " -----------------------------------------------------------\n";
        String sep2 = " -----------------------------------------------------------\n";
        String sep3 = " -----------------------------------------------------------\n";
    ...
    } // TODO : make it to display directly to the window
